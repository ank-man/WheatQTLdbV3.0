        ...
        <div className="space-y-6">
          ...
          <div className="card">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex items-center rounded-lg border border-wheat-200 bg-wheat-50 p-1 dark:border-ink-700 dark:bg-ink-800">
                <button
                  onClick={() => setView('ideogram')}
                  className={`rounded-md px-3 py-1 text-xs font-medium transition ${
                    view === 'ideogram'
                      ? 'bg-white text-wheat-800 shadow-sm dark:bg-ink-700 dark:text-wheat-100'
                      : 'text-wheat-600 hover:text-wheat-800 dark:text-wheat-400 dark:hover:text-wheat-200'
                  }`}
                >
                  Ideogram
                </button>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <div className="flex items-center gap-3 rounded-lg border border-wheat-200 bg-wheat-50 px-3 py-2 dark:border-ink-700 dark:bg-ink-800">
              ...
              <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="text-xs font-medium text-wheat-600 underline-offset-2 hover:text-wheat-800 hover:underline dark:text-wheat-400 dark:hover:text-wheat-200"
                  >
                    Select all
                  </button>
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium transition-colors ${
                        active
                          ...
                          : 'border-wheat-300 bg-white text-wheat-700 hover:bg-wheat-100 dark:border-wheat-600 dark:bg-ink-800 dark:text-wheat-200 dark:hover:bg-ink-700'
                      }`}
          ...
          <div className="card">
            ...
            {view === 'ideogram' ? (
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">Chromosomes</p>
                ...
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">QTL density strip</p>
                  <p className="text-sm leading-relaxed text-wheat-700 dark:text-wheat-300">
                ...
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">MetaQTL brackets</p>
                  <p className="text-sm leading-relaxed text-wheat-700 dark:text-wheat-300">
                ...
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">Trait highlights</p>
                  <p className="text-sm leading-relaxed text-wheat-700 dark:text-wheat-300">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">QTL density</p>
                ...
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">MetaQTL tracks</p>
                  <p className="text-sm leading-relaxed text-wheat-700 dark:text-wheat-300">
                ...
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">QTL tracks</p>
                  <p className="text-sm leading-relaxed text-wheat-700 dark:text-wheat-300">
                ...
                <div>
                  <p className="font-medium text-wheat-800 dark:text-wheat-200">Epistatic links</p>
                  <p className="text-sm leading-relaxed text-wheat-700 dark:text-wheat-300">
