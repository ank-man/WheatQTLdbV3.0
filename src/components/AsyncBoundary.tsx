...
export default function AsyncBoundary({ loading, error, empty, emptyMessage, children }: Props) {
  if (loading) {
    return (
      <div className="flex items-center gap-2 rounded-lg border border-wheat-200 bg-white p-6 text-wheat-700 dark:border-ink-700 dark:bg-ink-800 dark:text-wheat-200">
  ...
  if (empty) {
    return (
      <div className="rounded-lg border border-wheat-200 bg-white p-6 text-wheat-700 dark:border-ink-700 dark:bg-ink-800 dark:text-wheat-200">
